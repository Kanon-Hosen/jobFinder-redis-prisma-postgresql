...
export default function Hero() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700">
      {/* Floating Elements */}
      ...
      <div className="relative max-w-7xl mx-auto md:px-6 px-2 py-16 lg:py-20">
      ...
      <div className="absolute  -bottom-1 left-0 right-0">
        <svg viewBox="0 0 1440 120" className="w-full border-none outline-none fill-slate-50">
